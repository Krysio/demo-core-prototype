...
import { TxnTypeAdmin, TxnTypeUser } from "./Base";
...
export class TxnInsertDocument extends TxnTypeUser {
    protected type = TYPE_TXN_INSERT_DOCUMENT;
...
export default {
    [TYPE_TXN_INSERT_DOCUMENT]: TxnInsertDocument
}
